...
<!-- Mirrored from www.worryfreelawnmn.com/spring-and-fall-cleanup/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 19:56:34 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="pingback" href="{{ asset('site/xmlrpc.php')}}" />
    ...
    <script type="text/javascript">
      let jqueryParams = [],
        jQuery = function (r) {
          return (jqueryParams = [site.jqueryParams, r]), jQuery;
        },
        $ = function (r) {
          return (jqueryParams = [site.jqueryParams, r]), $;
        };
      ...
      (jQuery.fn = jQuery.prototype = {}),
        ...
        (jQuery.ready = function (r) {
          jqueryParams = [site.jqueryParams, r];
        }),
        ($.ready = function (r) {
          jqueryParams = [site.jqueryParams, r];
        }),
    ...
    <title>Lawn Clean Up | Minneapolis - Naji Lawn and Snow</title>
    <meta
      name="description"
      content="Naji Lawn and Snow are your Minneapolis healthy lawn experts with Fall leaf clean up, leaf &amp; debris removal, and Spring yard aeration."
    />
    ...
    <meta
      property="og:title"
      content="Lawn Clean Up | Minneapolis - Naji Lawn and Snow"
    />
    <meta
    ...
    <meta
      property="og:url"
      content="https://www.worryfreelawnmn.com/spring-and-fall-cleanup/"
    />
    <meta property="og:site_name" content="Naji Lawn and Snow" />
    <meta
      property="article:modified_time"
      content="2022-09-22T14:37:06+00:00"
    />
    ...
    <link
      ...
      title="Naji Lawn and Snow &raquo; Feed"
      href="{{ asset('site/feed/index.html') }}"
    />
    <link
      rel="alternate"
      type="application/rss+xml"
      title="Naji Lawn and Snow &raquo; Comments Feed"
      href="{{ asset('site/comments/feed/index.html') }}"
    />
    <meta content="Divi Child v.1.0.0" name="generator" />
    <link
      rel="stylesheet"
      id="ags-divi-icons-css"
      href="{{ asset('site/wp-content/plugins/wp-and-divi-icons/css/icons.minfeec.css')}}"
      type="text/css"
      media="all"
    />
...
*/
      ...
      * {
      ...
      .et_pb_preload:before {
        ...
        top: 50%;
        left: 50%;
        background: url(site/wp-content/themes/Divi/includes/builder/styles/images/preloader.gif)
          no-repeat;
        border-radius: 32px;
        width: 32px;
        height: 32px;
    ...
    <style id="divi-dynamic-critical-inline-css" type="text/css">
      @font-face {
        ...
        src: url(//www.worryfreelawnmn.com/wp-content/themes/Divi/core/admin/fonts/modules/all/modules.eot?#iefix)
            format("embedded-opentype"),
          url(//www.worryfreelawnmn.com/wp-content/themes/Divi/core/admin/fonts/modules/all/modules.ttf)
            format("truetype"),
          url(//www.worryfreelawnmn.com/wp-content/themes/Divi/core/admin/fonts/modules/all/modules.woff)
            format("woff"),
          url(//www.worryfreelawnmn.com/wp-content/themes/Divi/core/admin/fonts/modules/all/modules.svg#ETmodules)
            format("svg");
        font-weight: 400;
        font-style: normal;
      }
	 ...
	 */
      ...
      .et_pb_newsletter_form
        p.et_pb_newsletter_field.et_pb_signup_custom_field {
        padding-left: 0;
      }
      ...
      @media (max-width: 980px) {
        ...
        p.et_pb_contact_field_half_tablet
          + p.et_pb_contact_field_last_tablet:not(
      ...
      @media (max-width: 767px) {
        ...
        .et_pb_newsletter
          .et_pb_contact_field_last_phone
          + .et_pb_newsletter_field {
          padding-left: 0;
        }
        .et_pb_newsletter
          .et_pb_newsletter_form
          .et_pb_contact_field_half_phone {
          -ms-flex-preferred-size: 48.5%;
          flex-basis: 48.5%;
        }
        .et_pb_newsletter
      ...
      @media (max-width: 767px) {
        ...
        p.et_pb_contact_field_half_phone
          + p.et_pb_contact_field_last_phone:not(
            .et_pb_contact_field_half_phone
          ) {
          clear: both;
        }
    ...
    <link
      rel="preload"
      id="divi-dynamic-css"
      href="{{ asset('site/wp-content/et-cache/25/et-divi-dynamic-25185b.css')}}"
      as="style"
      media="all"
    ...
    <link
      rel="stylesheet"
      id="supreme-modules-for-divi-styles-css"
      href="{{ asset('site/wp-content/plugins/supreme-modules-for-divi/styles/style.mina305.css')}}"
      type="text/css"
      media="all"
    />
    <link
    ...
    <link
      rel="stylesheet"
      id="divi-style-css"
      href="{{ asset('site/wp-content/themes/divi-child/style7f9d.css')}}"
      type="text/css"
      media="all"
    />
    <script
      type="text/javascript"
      src="{{ asset('site/wp-includes/js/jquery/jquery.mina7a0.js')}}"
      id="jquery-core-js"
    ></script>
    <script
      type="text/javascript"
      src="{{ asset('site/wp-includes/js/jquery/jquery-migrate.mind617.js')}}"
    ...
    <script type="text/javascript" id="ags-divi-icons-js-extra">
      ...
      var ags_divi_icons_config = {
        pluginDirUrl:
          "https:\/\/www.worryfreelawnmn.com\/wp-content\/plugins\/wp-and-divi-icons",
      };
      /* ]]> */
    </script>
    <script
      type="text/javascript"
      src="{{ asset('site/wp-content/plugins/wp-and-divi-icons/js/icons.minfeec.js')}}"
      id="ags-divi-icons-js"
    ></script>
    <link rel="https://api.w.org/" href="{{ asset('site/wp-json/index.html') }}" />
    <link
      rel="alternate"
      type="application/json"
      href="{{ asset('site/wp-json/wp/v2/pages/25.json')}}"
    />
    <link
      rel="EditURI"
      type="application/rsd+xml"
      title="RSD"
      href="{{ asset('site/xmlrpc0db0.php')}}"
    />
    <link
      rel="wlwmanifest"
    ...
    <link rel="shortlink" href="https://www.worryfreelawnmn.com/?p=25" />
    <link
      rel="alternate"
      type="application/json+oembed"
      href="{{ asset('site/wp-json/oembed/1.0/embedcd71.json?url=https%3A%2F%2Fwww.worryfreelawnmn.com%2Fspring-and-fall-cleanup%2F')}}"
    />
    <link
      rel="alternate"
      type="text/xml+oembed"
      href="{{ asset('site/wp-json/oembed/1.0/embedf1e2?url=https%3A%2F%2Fwww.worryfreelawnmn.com%2Fspring-and-fall-cleanup%2F&amp;format=xml')}}"
    />
    <!-- Google Tag Manager -->
    <script>
      (function (w, d, s, l, i) {
        ...
        var f = d.getElementsByTagName(s)[0],
          ...
          dl = l != "dataLayer" ? "&l=" + l : "";
        j.async = true;
        j.src = "{{ asset('site/site/www.googletagmanager.com/gtm5445.html') }}?id=" + i + dl;
    ...
    <meta
      ...
      content="3oOdlfcOEaXaJyMp2ap70beA5dGNweAtTm0LckAt5II"
    />
    <meta
      name="google-site-verification"
      content="AyPRtlkgsPStDrAKPoeDHg8Wt4Bwj8imszrZj768GCg"
    />
    <meta
      name="viewport"
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=G-2ZSXYST8N3"
    ></script>
    <script>
...
<link rel="icon" type="image/x-icon" href="{{ asset('site/Naji_1.png') }}">
    ...
    <style id="et-critical-inline-css">
      ...
      div.et_pb_section.et_pb_section_0 {
        ...
        background-image: url(site/wp-content/uploads/2020/12/Minneapolis-Dethatching-Service-Banner.jpg) !important;
      }
      .et_pb_section_0 {
        width: 100%;
      }
    ...
    <link
      rel="preload"
      as="style"
      id="et-core-unified-deferred-25-cached-inline-styles"
      href="{{ asset('site/wp-content/et-cache/25/et-core-unified-deferred-25.min7d1d.css') }}"
      onload="this.onload=null;this.rel='stylesheet';"
    />
  </head>

<body
    class="page-template-default page page-id-25 custom-background et_pb_button_helper_class et_fullwidth_nav et_fixed_nav et_show_nav et_primary_nav_dropdown_animation_fade et_secondary_nav_dropdown_animation_fade et_header_style_left et_pb_footer_columns1 et_cover_background et_pb_gutter linux et_pb_gutters2 et_pb_pagebuilder_layout et_no_sidebar et_divi_theme et-db">
                  ...
                  <div class="et-l et-l--post">
                    <div class="et_builder_inner_content et_pb_gutters2">
                      ...
                      >
                            ...
                            <div class="header-content-container center">
                              <div class="header-content">
                                ...
                                <div class="et_pb_header_content_wrapper">
                                  <p>
                                    <span
                                      >Feel free to give us a call if you want more
                                      information about any of our services</span
                                    >
                                  </p>
                                </div>
                        ...
                        <div
                          class="et_pb_bottom_inside_divider et-no-transition"
                        ></div>
                      </div>
                            ...
                            >
                              <div class="et_pb_text_inner">
                                <h1 style="text-align: center">
                                  <span>Dethatching Services<br /> </span>in
                          ...
                          >
                            ...
                            >
                              <div class="et_pb_module_inner">
                                <div
                                  class="dsm-perspective-image-wrapper et_always_center_on_mobile"
                                >
                                  <span class="et_pb_image_wrap"
                                    ><img
                                      decoding="async"
                                      src="{{ asset('site/wp-content/uploads/2020/12/Dethatching-Service-Minneapolis.jpg') }}"
                                      alt="Dethatching Service Minneapolis"
                                      title="Dethatching Service Minneapolis"
                                  /></span>
                                </div>
                              </div>
                            </div>
                            ...
                            >
                              <div class="et_pb_text_inner">
                                <p>
                                  Thatch is a buildup of dead grass that develops
                                  over time between the grass and the dirt. When
                                  this dead plant material doesn’t break down as it
                                  should, it can become a serious problem for the
                                  living grass, preventing water and nutrients from
                                  reaching the roots.
                                </p>
                                <p>
                                  The good news is that we can quickly and easily
                                  take care of thatch for you and help your lawn
                                  become healthy and strong again so that it can be
                                  as green and luscious as you would like it to be.
                                  We use special equipment and techniques to get in
                                  and remove thatch from your lawn.
                                </p>
                              </div>
                            </div>
                          </div>
...
<!-- Mirrored from www.worryfreelawnmn.com/spring-and-fall-cleanup/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 19:56:38 GMT -->
